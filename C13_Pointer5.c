...
void PrintAry(int* ptr, int size){// int ptr[]
    printf("------------\n");
    for(int i=0; i<size; i++){
...
// ---------------------------------------
// GetSumAry함수는, 배열과 사이즈를 넘겨받아, 배열내 모든
...
// GetAvgAry함수는, 배열과 사이즈를 넘겨받아, 배열내 모든
...
void SetEvenZero(int* ptr, int size){
    for(int i=0; i<size; i++)
        if( *(ptr+i)%2 == 0) 
            *(ptr+i)=0;
    PrintAry(ptr, size);
...
void SetOddZero(int* ptr, int size){
    for(int i=0; i<size; i++)
        if( *(ptr+i)%2 != 0) 
            *(ptr+i)=0;
    PrintAry(ptr, size);
