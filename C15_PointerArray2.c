...
// < 함수 자리 >
// =========================================================
// 1차원 배열을 넘겨받으면, 랜덤값1~9를 채우는 함수 구현
...
// 어려운버전으로 void PrintPAry 를 void PrintPAry2 로만들기
...
// -----------------------------------------
void Quiz2(int** ptrs4, int size, int* cols){
    int max = -9999;
    int min =  9999;
